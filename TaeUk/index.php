...
<html lang='ko'>
	<head>
		...
		<link rel="stylesheet" href="index.css?ver1.31" type="text/css">		
	</head>
	<body>
	<?php	//DB 연결 시도
			try{
			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
					<div class="navbar-header">
						<span class="navbar-brand" id="nb" href="index.php">Report Assistant</span> <!-- @ 하이라이트 꺼주세요 -->
					</div>
					<ul class="nav navbar-nav">
					  <li class="active"><a href="index.php?b_login=0">Home</a></li>
...
<!-- 로그인창 -->
				...
				<div class="row-fluid">				
					<div class="col-sm-3 col-xs-12">
						<div class="row">
							...
							<div class="col-sm-12 col-xs-12" id="window_login">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-9 col-xs-9">
											<div class="row">
												<strong class="id col-sm-3 col-xs-3">ID</strong>
												<input class="input_id col-sm-9 col-xs-9" type='text' placeholder="아이디">													
												<strong class="pw col-sm-3 col-xs-3">PW</strong>
												<input class="input_pw col-sm-9 col-xs-9" type='password' placeholder="비밀번호">
											</div>
										</div>	
										<div class="col-sm-3 col-xs-3 temp">	
											<button class="login_btn btn btn-lg">login</button>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-12 col-xs-12" id='login_bottom' >
								<p>	
									뭐에 쓰지...
								</p>
							</div>
					...
					<div class="col-sm-9 col-xs-12" id="window_intro">
						<p>
							설명하는 공간...
						</p>
					</div>
	...
	?>	
		<nav class="navbar navbar-inverse">
  			<div class="container-fluid">
    			<div class="navbar-header">
      				<span class="navbar-brand" href="index.php">Report Assistant</span> <!-- @ 하이라이트 꺼주세요 -->
    			</div>
				<ul class="nav navbar-nav">
					<li class="active"><a href="index.php?b_login=1">Home</a></li>
		...
		<div class="container">
    		<div class="col-sm-12">
				<form action="" method="POST">
					...
					<div>	
						<?php
							$jsondata = $_GET['https://www.googleapis.com/customsearch/v1?q=%EC%82%B4%EC%9D%B8&c2coff=1&cx=001579166103861849215%3Acgdipvl_ujy&highRange=google.com&key=AIzaSyB7m3nrmf2j-qXBg3wnmO6PUfDRTxmh_y0'];
							//var_dump($jsondata);
						?>
						<script>
						  (function() {
	...
	<script src="index.js?ver1.00"></script>	
	</body>
</html>