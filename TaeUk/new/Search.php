...
<head>
  ...
  <link rel="stylesheet" href="Main.css?ver1.003"> 
</head>
<body>
    ...
    <div class="col-sm-8 col-xs-12 text-left main center-block"> 		
		<div class="main_after">
			...
			<!--form action="" method="POST"-->
				...
				<input type="submit" name="search_btn" class="form-control btn center-block" id="search_btn" value="Search">
			<!--/form-->
			<div id="report_result">
				<!--input type="hidden" id="keyword2" value=<?=$_POST["search"]?>-->
			</div>
		</div>
	</div>
