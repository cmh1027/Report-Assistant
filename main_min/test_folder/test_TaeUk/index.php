...
<html lang='ko'>
	<head>
		...
		<link rel="stylesheet" href="index.css?ver1.27" type="text/css">		
	</head>
	<body>
	<?php	//DB 연결 시도
			try{
...
<!-- 로그인창 -->
			...
			<div class="col-sm-12 col-xs-12 row-fluid">
				<div class="col-sm-3 col-xs-12 row-fluid">
					<div class="col-sm-12 col-xs-12 row-fluid" id="window_login" >
					...
					<!--div class="col-sm-12 col-xs-12 row-fluid" style="border:1px solid black">
						<p>	
							뭐에 쓰지...
						</p>
					</div-->
